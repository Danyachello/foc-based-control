...
Для задания желаемого значения в serial необходимо написать команду Ta, где а  - желаемое значение тока/скорости/положения.

При управлении контуром скорости необходимо задать три параметра - максимальное значение скорости, максимальное ускорение и желаемое значение угла, на основе этих параметров и строится трапеция. Для задания этих величин в serial вводятся комады GAv для ускорения, GVv для скорости и Gv для угла, где v - желаемое значение параметров. При траекторном управлении команда Tv недоступна.
