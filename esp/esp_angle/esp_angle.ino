...
BLDCDriver3PWM driver = BLDCDriver3PWM(5, 27, 16, 14); //инициализация драйвера
Encoder encoder = Encoder(18,19,1000,23); //инициализация энкодера
void doA(){encoder.handleA();}
void doB(){encoder.handleB();}
void doIndex(){encoder.handleIndex();}
float target_angle = 10; //желаемое значение угла поворота

//InlineCurrentSense current_sense = InlineCurrentSense(0.01, 50.0, 39, 36);//инициализация чтения значений фазных токов
